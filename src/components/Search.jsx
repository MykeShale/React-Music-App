    ...
    <div className="search relative h-[65rem] px-[5rem] bg-[#081730] pt-[18rem] pb-[10rem] mt-[-15rem] z-[1] flex items-center justify-between rounded-b-[5rem]">
      ...
      <div className="left flex-1">
        <motion.img
          ...
          alt=""
          className="absolute top-[22rem] left-[-47rem] z-0"
        />
        <motion.img
      ...
      <div className="right flex items-start flex-col justify-start flex-1 h-[100%] pt-[9rem]">
        ...
        <div className="detail flex flex-col mt-5 text-4xl">
          ...
          <span className="text-sm mt-3 text-[#4D586A]">
            Type your choice of music in the above search icon <br /> 
            Youe can search by music genre, artist, or <br /> your preferred choice.
          </span>
        </div>
        {/* Music Player */}
        <VisibilitySensor
